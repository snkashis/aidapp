<?php  
    ...
    include ("config.php");    
    $clear_results = "UPDATE Results SET resp_shake = '0',resp_shout = '0',ab_chin =  '0',ab_breathing = '0',ab_telephone = '0',cpr_compressions = '0',cpr_chin =  '0',cpr_nose = '0',cpr_breaths = '0', danger = '0' WHERE id='guest'";
