<?php  
    ...
    $set_resp_shake = "UPDATE Practice SET resp_shake='1'";
    $set_resp_shout = "UPDATE Practice SET resp_shout='1'";
    
    $set_ab_chin = "UPDATE Practice SET ab_chin='1'";
    $set_ab_breathing = "UPDATE Practice SET ab_breathing='1'";
    $set_ab_telephone = "UPDATE Practice SET ab_telephone='1'";
    
    $set_cpr_compressions = "UPDATE Practice SET cpr_compressions='1'";
    $set_cpr_chin = "UPDATE Practice SET cpr_chin='1'";
    $set_cpr_nose = "UPDATE Practice SET cpr_nose='1'";
    $set_cpr_breaths = "UPDATE Practice SET cpr_breaths='1'";
